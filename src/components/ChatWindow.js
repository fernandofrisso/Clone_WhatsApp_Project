        ...
        <div className='chatWindow'>
           ...
           <div className='chatWindow--header'>
                ...
                <div className='chatWindow--headerInfo'>
                        ...
                        <img className='chatWindow--avatar' src='https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSo7WfE6wFfdpeFph92LdEFJFnula0ecIObiQ&usqp=CAU' alt=''/>
                        <div className='chatWindow--name'>Fernando Frisso</div>
                </div>
           ...
           <div className='chatWindow--footer'>
                ...
                <div className='chatWindow--imputarea'>
